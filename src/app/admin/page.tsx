      ...
      <div className="bg-white border border-[#E5E5E0] rounded-xl shadow-sm overflow-hidden">
        {posts.length === 0 ? (
          ...
          <div className="divide-y divide-[#E5E5E0]">
            {posts.map((post: any) => (
              <div key={post.id} className="p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-[#FAFAF8] transition-colors">
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center flex-wrap gap-2 sm:gap-3 mt-1.5 text-[13px] font-medium">
                    ...
                    <span className="text-[#1a1a1a]/40 tracking-wide break-all">/blog/{post.slug}</span>
